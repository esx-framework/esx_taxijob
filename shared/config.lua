...
Config.MinimumDistance       = 400 -- Minimum NPC job destination distance from the pickup in GTA units, a higher number prevents nearby destionations. (default: 400)
Config.ShowPriceToPassengers = true -- Sync the price value to passengers? (default: true)
...
Config.Positions = {
  ...
  VehicleReturn = vector3(894.88, -180.23, 74.5),
}
